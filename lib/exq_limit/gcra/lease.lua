...
local emission_interval, burst = ARGV[1], ARGV[2]
...
if remaining < 0 then
  ...
  redis.call("SET", tat_key, new_tat, "EX", math.ceil(reset_after))
  retry_after = -1
end

return {limited, tostring(retry_after), tostring(reset_after)}
